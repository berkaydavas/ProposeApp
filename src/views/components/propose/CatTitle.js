...
export default class CatTitle extends Component {
    render() {
        return (
            <tr className="tableWrapLine" data-parent-id={this.props.parentId} data-visual-id={this.props.data.visualId}>
                <td colSpan={this.props.colspan} className="p-0">
                    <table className="table table-sm table-bordered table-responsive-sm catTitleTable mb-1 align-middle">
                        <colgroup>
                            <col className="key" />
                            <col className="brand" />
                        ...
                        <tbody>
                            {
                                this.props.data.children && this.props.data.children.filter(x => x.type === 0).map(line =>
                                    <ProductLine
                                        key={_.uniqueId("proposeCatTitleProductLine-")}
                                        data={line}     
